    ...
    <div class="flex justify-center items-center gap-4 mt-8 mb-6">
        <div class="relative">
            ...
            <p class="mt-4 text-sm absolute w-full text-center">For
                <span class="font-semibold">Mac</span> & <span class="font-semibold">Windows</span>
            </p>
        </div>
...
<div id="carousel" class="relative xl:mt-8 mx-4 md:mx-6 xl:m-auto">
    ...
    <div class="absolute bottom-0 w-full -z-[1]">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
            <path fill="#f7f8fa" fill-opacity="1"
                d="M0,192L48,197.3C96,203,192,213,288,181.3C384,149,480,75,576,69.3C672,64,768,128,864,160C960,192,1056,192,1152,176C1248,160,1344,128,1392,112L1440,96L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z">
            </path>
        </svg>
