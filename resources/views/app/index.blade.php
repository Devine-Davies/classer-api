@php
	$steps = [
		[
			...
			'image' => $cloudAssetUrl('assets/images/app-features-screenshots/feature-01.png'),
		...
		[
			...
			'image' => $cloudAssetUrl('assets/images/app-features-screenshots/feature-02.png'),
		...
		[
			...
			'image' => $cloudAssetUrl('assets/images/app-features-screenshots/feature-03.png'),
		...
		[
			...
			'image' => $cloudAssetUrl('assets/images/app-features-screenshots/feature-04.png'),
			'alt' => 'Browse your adventures on desktop and tablet',
			'imagePosition' => 'right',
		],
		[
			...
			'image' => $cloudAssetUrl('assets/images/app-features-screenshots/feature-05.png'),
			'alt' => 'Browse your adventures on desktop and tablet',
			'imagePosition' => 'left',
		],
	];
