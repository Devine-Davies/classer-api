			...
			<tr>
				<td>
					<table align="center" border="0" cellpadding="0" cellspacing="0" class="row row-1"
						role="presentation"
						style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #0A404D;" width="100%">
						<tbody>
							<tr>
								<td>
									<table align="center" border="0" cellpadding="0" cellspacing="0"
										class="row-content stack" role="presentation"
										style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #0A404D; color: #000000; width: 640px;"
										width="640">
										<tbody>
											<tr>
																	...
																	<table border="0" cellpadding="0" cellspacing="0"
																		...
																		<tr>
																			<td class="divider_inner"
																				style="font-size: 1px; line-height: 1px; border-top: 4px solid #0A404D;">
																				<span> </span></td>
																		</tr>
																	</table>
																</div>
																...
																<div style="font-family: sans-serif">
																	<div class=""
																		...
																		<p
																			style="margin: 0; font-size: 16px; text-align: center; mso-line-height-alt: 19.2px;">
																			<span
																				style="font-size:30px;color:#0A404D;"><strong>CODE:
																				{{$data['code']}}</strong></span></p>
																	</div>
																</div>
															</td>
														</tr>
																	...
																	<div class=""
																		...
																		<p
																			...
																			<span
																				...
																				firsthand. We welcome any feedback!</span></p>
																	</div>
																</div>
															</td>
														</tr>
															...
															<td class="pad"
																...
																<div align="center" class="alignment">
																	...
																	<div
																		...
																		<a
																			href="https://classermedia.com/?modal=trial-download&trial-code={{$data['code']}}"
																...
																<div style="font-family: sans-serif">
																	<div class=""
																		...
																		<p
																			...
																			<span
																				style="color:#95979c;font-size:12px;">Classer © 2023</span></p>
																	</div>
																</div>
															</td>
														</tr>
