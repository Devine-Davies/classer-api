@php
    $values = [
        [
            'title' => 'Connection',
            'image' => $cloudAssetUrl('assets/images/about/title-1.jpg'),
        ...
        [
            ...
            'image' => $cloudAssetUrl('assets/images/about/title-2.jpg'),
        ...
        [
            'title' => 'Joy',
            'image' => $cloudAssetUrl('assets/images/about/title-3.jpg'),
            ...
            <div class="grid gap-12 lg:grid-cols-2 lg:items-center">
                ...
                <figure class="relative">
                    <div class="overflow-hidden rounded-xl">
                        ...
                        <img src="{{ $cloudAssetUrl('assets/images/about/founders-2.jpg') }}"
