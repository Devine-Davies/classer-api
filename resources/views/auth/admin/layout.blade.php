        ...
        [
            ...
            'items' => [
                [
                    ...
                    'label' => 'Stats',
                    'icon' => 'location',
                    'url' => url('/auth/admin/stats'),
                ],
                [
                    'section' => 'trends',
                    'label' => 'Trends',
                    'icon' => 'trending-up',
                    'url' => url('/auth/admin/trends'),
                ],
                [
                    'section' => 'bulk-mails',
                    'label' => 'Bulk Emails',
                    'icon' => 'location',
                    'url' => url('/auth/admin/bulk-mails'),
                ],
                [
                    'section' => 'logs',
                    'label' => 'Logs',
                    'icon' => 'logs',
                    'url' => url('/auth/admin/logs'),
                ],
            ],
        ],
    ];
