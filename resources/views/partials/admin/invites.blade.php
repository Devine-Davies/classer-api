<div class="p-6 bg-white border border-gray-200 rounded-lg shadow-sm">
    ...
    <form id="invite-form" hx-post="{{ url('/') }}/api/admin/send-invites" hx-target="#invite-feedback"
        hx-swap="innerHTML" hx-indicator="#invite-spinner" class="space-y-4">
        @csrf
        ...
        <button type="submit"
            ...
            <svg id="invite-spinner" class="ml-2 h-5 w-5 animate-spin hidden hx-indicator" viewBox="0 0 24 24"
                fill="none">
