...
<div>
    <div class="text-center">
        <h3 class="text-4xl font-bold text-brand-color mb-8">Where adventures matter, clutter doesn’t</h3>
        <p>The desktop tool for all your post-recording process.</p>
    </div>
    <div class="flex gap-8 flex-col md:flex-row justify-between w-full relative mb-6 md:mt-16 lg:mt-16">
        ...
        <div class="relative flex items-center md:items-start flex-col">
            <img class="mx-auto w-28 h-28 md:w-32 md:h-32 lg:w-44 lg:h-44"
                src="{{ asset('/assets/images/welcome/how-it-works/step1.svg') }}" alt="sync">
            <div class="text-center">
                <h3 class="font-semibold" >Step 1</h3>
                <p class="text-center mt-4 max-w-xs md:mt-3">Upload your footage to Classer from your card, camera hard drive or computer.</p>
            </div>
        </div>
        <div class="relative flex items-center flex-col">
            <img class="mx-auto w-28 h-28 md:w-32 md:h-32 lg:w-44 lg:h-44"
                src="{{ asset('/assets/images/welcome/how-it-works/step2.svg') }}" alt="classer">
            <div class="text-center">
                <h3 class="font-semibold">Step 2</h3>
                <p class="mt-4 mx-auto max-w-xs md:mt-3">Automatically recognise your Available for Mac and Windows
                    folder structure, or if you prefer start from scratch</p>
            </div>
        </div>
        <div class="relative flex items-center md:items-end flex-col">
            <img class="mx-auto w-28 h-28 md:w-32 md:h-32 lg:w-44 lg:h-44"
                src="{{ asset('/assets/images/welcome/how-it-works/step3.svg') }}" alt="share">
            <div class="text-center">
...
<section class="text-center mt-8 lg:mt-12">
    ...
    <p class="mt-3">Available for <span class="font-semibold" >Mac</span> and <span class="font-semibold" >Windows<span></p>
