        ...
        <div class="flex justify-center flex-wrap md:flex-nowrap mt-8 md:mt-10 m-auto gap-8 md:gap-8">
            <div class="w-full text-center rounded-md max-w-md border">
                ...
                <div>
                    ...
                    <div class="py-12">
                        ...
                        <p class="mt-2 text-sm">Available for <span class="font-semibold">Mac</span> and <span
            ...
            <div class="w-full text-center rounded-md max-w-md border relative">
                <div class="bg-badge p-4 w-full text-center">
                    ...
                    <p class="my-4 max-w-sm m-auto">Ideal for keeping your moments on the cloud and share them with
