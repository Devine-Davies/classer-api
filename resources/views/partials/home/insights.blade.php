@php
    $reviews = [
        [
            ...
            'rating' => 5,
            'text' =>
                'Classer has been a total lifesaver for me in managing all my Insta360 footage. Now, I can quickly whip up and share the coolest moments from my outdoor adventures without breaking a sweat!',
        ],
        [
            'name' => 'Manuel',
            ...
            'rating' => 4,
            'text' =>
                'Discovering Classer transformed my GoPro adventures. Now, every MTB moment  is organized and ready to share with my mates!',
        ],
        [
            'name' => 'Seren Giles',
            ...
            'rating' => 5,
            'text' =>
                'I never thought organizing my family\'s memories could be so enjoyable until I started using Classer. From birthdays to vacations, I now have all our precious moments neatly sorted.',
        ],
        [
            'name' => 'Billy O\'Moore',
            'date' => 'January 23, 2023',
            ...
            'rating' => 5,
            'text' =>
                'Being a travel blogger, I often found myself drowning in a sea of videos from my trips. Thanks to Classer, I can easily curate stunning visual stories, captivating my audience with every adventure I share.',
        ],
        // [
        //     'name' => 'Tamsyn Lana',
        //     'date' => 'January 23, 2023',
...
<section class="test" class="py-10">
    ...
    <div class="flex justify-center overflow-x-auto space-x-6 no-scrollbar pb-4">
        @foreach ($reviews as $review)
            <div class="w-80 flex-shrink-0 bg-white rounded-lg shadow p-5">
                ...
                <div class="mb-2 flex gap-1">
                    @for ($i = 1; $i <= 5; $i++)
                        @if ($i <= $review['rating'])
                            <span class="text-yellow-400">@icon(star)</span>
                        @else
                            <span class="text-gray-300">@icon(star)</span>
                        @endif
                    @endfor
                </div>
                <p>
