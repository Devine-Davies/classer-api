...
<body class="antialiased" trial-code="<?php echo $trialCode; ?>">
    ...
    <!-- Features -->
    <section id="features" class="overflow-hidden w-full mt-8 p-4">
    ...
    <section class="bg-off-white">
        <div class="mx-auto max-w-7xl py-8 md:py-16 px-6">
            <!-- text-center font-bold mb-8 text-2xl sm:px-16 md:text-4xl md:mb-16 xl:px-48  -->
            <h3 class="text-4xl font-bold text-center text-brand-color mb-8">
                How Classer works
            </h3>
            ...
            <div class="flex gap-8 flex-col md:flex-row justify-between w-full relative mb-6 md:mt-16 lg:mt-16">
                ...
                <div class="relative flex items-center md:items-start flex-col flex-1">
                    ...
                    <p class=" max-w-xs font-semibold md:mt-3">Sync from your external hard drives, SD cards, or any
                ...
                <div class="relative flex items-center flex-col">
                    ...
                    <p class=" mx-auto max-w-xs font-semibold md:mt-3">Designed for Desktop, built for you</p>
                </div>
                <div class="relative flex items-center md:items-end flex-col flex-1">
                    ...
                    <p class=" md:text-end max-w-xs font-semibold md:mt-3">Automatically recognise your folder
    ...
    <section class="bg-off-white hidden">
        <div class="mx-auto py-8 md:py-16 px-12">
    ...
    <!-- FAQ's -->
    <section>
        <div class="mx-auto mb-6 md:max-w-5xl p-4 md:py-12">
            <h2 class="text-4xl font-bold text-center text-brand-color">FAQ's</h2>
            <div id="faqs"
    ...
    <footer class="bg-off-white w-full px-4">
        <div class="max-w-7xl m-auto flex flex-col md:flex-row justify-between gap-4 py-6 md:py-12">
            ...
            <div class="text-center md:text-right grid grid-cols-2 md:grid-cols-1">
