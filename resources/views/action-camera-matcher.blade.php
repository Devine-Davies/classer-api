...
<body class="antialiased">
            ...
            <div class="max-w-xl mx-auto lg:max-w-screen-xl">
                <div class="mb-16 lg:max-w-lg lg:mb-0">
                    ...
                    <div class="flex items-center">
                        ...
                        <a href="/" aria-label=""
                            class="ml-4 inline-flex items-center font-semibold transition-colors duration-200 text-deep-purple-accent-400 hover:text-deep-purple-800">Learn
                            more</a>
                    </div>
                </div>
            </div>
    ...
    <article tabindex="-1" data-modal="action-camera-matcher"
        class="overflow-hidden max-h-full fixed top-0 right-0 left-0 bottom-0 z-50 h-full w-full justify-center align-center backdrop-blur-md">
        <div class="p-4 m-auto w-1/1 max-w-5xl relative">
            <div data-classer-billboard class="hidden bg-white rounded-lg shadow overflow-hidden mb-4">
                ...
                <form>
                    ...
                    @for ($i = 0; $i < count($formdata); $i++)
                        ...
                        <div class="m-auto max-w-lg hidden" id="form-question-block-{{ $i }}"
                            ...
                            <h1
                                class="text-xl lg:text-4xl font-bold text-center text-brand-color mb-6">
                                {{ $formdata[$i]['title'] }}
                            </h1>
