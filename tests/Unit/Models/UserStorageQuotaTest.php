...
class UserStorageQuotaTest extends TestCase
{
    ...
    public function test_can_upload_uses_total_usage_and_active_subscription_quota(): void
    {
        ...
        $this->assertTrue($user->canUpload(40));
        $this->assertFalse($user->canUpload(41));
        $this->assertSame(40, $user->remainingStorage());
    }
